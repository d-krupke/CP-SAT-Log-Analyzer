...
| `backend/tests/test_static.py` | serving the built frontend: a real file, the SPA fallback for a client-side route, and that no encoded `..` climbs out of the static root |
