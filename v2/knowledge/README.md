...
| the intro of the Search progress plot, the Parameters card or the Subsolver contributions card | `blocks.toml` | `[cards]` |
...
`v2/backend/app/data/sat_parameters.json` by `tools/extract_sat_parameters.py`.
